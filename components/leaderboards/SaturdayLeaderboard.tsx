...
export default function SaturdayLeaderboard({
  searchedUsername,
}: {
      ...
      {userScore && (
        <div className="bg-green-100 text-black p-4 rounded shadow mb-2">
          <p className="font-bold mb-1">
            {userIndex! < 10
              ? "🎉 You're in the top 10 on Saturdays!"
              : "Here’s your Saturday leaderboard position:"}
          </p>
          <p>
      ...
      <div className="overflow-x-auto">
        ...
        {aggregated.length === 0 && (
          <p className="text-black text-center mt-4">
            No Saturday scores available yet.
          </p>
        )}
      </div>
    </div>
